...
function Hero() {
  return (
    <section className='min-h-[80vh] flex my-16 '>
      <div className='w-2/3 relative  after:w-48 after:h-48 after:absolute after:-top-4 after:-right-4 after:border-t after:border-r flex gap-6 items-end'>
        <div className='w-1/3 h-full  relative'>
          <div className='absolute top-[10%] left-4 z-10'>
            <h1 className='   text-8xl font-bold '>Beniourain</h1>
            <p className='text-6xl font-[200]'>Moroccan Rugs</p>
          </div>
          <div className='absolute z-10 bottom-20 left-4 w-full'>
        ...
        <div className='bg-green-100  relative  w-2/3  h-full before:absolute before:-z-10  before:-bottom-4 before:-left-4 before:w-full  before:h-full before:bg-amber-50 flex items-center justify-center'>
          <Image
      ...
      <div className='w-1/3 flex flex-col p-9 gap-4  '>
        <p className='mt-auto'>
